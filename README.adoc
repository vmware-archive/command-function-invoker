= Shell Function Invoker image:https://travis-ci.org/projectriff/shell-function-invoker.svg?branch=master["Build Status", link="https://travis-ci.org/projectriff/shell-function-invoker"]
